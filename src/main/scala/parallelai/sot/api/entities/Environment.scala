...
case class Environment(id: String, name: String, launchOpts: String, projectId: String, timestamp: Option[Instant] = Option(now)) extends TimedBaseEntity
...
object Environment {
  ...
  implicit val rootJsonFormat: RootJsonFormat[Environment] = jsonFormat5(Environment.apply)
}